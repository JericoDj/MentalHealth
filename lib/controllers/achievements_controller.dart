...
class AchievementsController extends GetxController {
  ...
  final UserProgressController _progressController = Get.find<UserProgressController>();
  ...
  Future<void> fetchUserAchievements() async {
    ...
    try {
      var achievementsRef = _firestore.collection("users").doc(uid).collection("achievements");
  ...
  Future<void> _createDefaultAchievements(String uid) async {
    List<Map<String, dynamic>> defaultAchievements = [
      {"title": "3-Day Streak", "icon": "🔥", "progress": 0, "goal": 3, "unlocked": false},
      {"title": "7-Day Streak", "icon": "🔥", "progress": 0, "goal": 7, "unlocked": false},
      {"title": "15-Day Streak", "icon": "🔥", "progress": 0, "goal": 15, "unlocked": false},
      {"title": "1 Month Streak", "icon": "🔥", "progress": 0, "goal": 30, "unlocked": false},
      {"title": "90-Day Streak", "icon": "🔥", "progress": 0, "goal": 90, "unlocked": false},
      {"title": "First Check-in", "icon": "✔️", "progress": 0, "goal": 1, "unlocked": false},
      {"title": "10 Check-ins", "icon": "✔️", "progress": 0, "goal": 10, "unlocked": false},
      {"title": "50 Check-ins", "icon": "✔️", "progress": 0, "goal": 50, "unlocked": false},
      {"title": "100 Check-ins", "icon": "⭐", "progress": 0, "goal": 100, "unlocked": false},
      {"title": "365 Check-ins", "icon": "🏆", "progress": 0, "goal": 365, "unlocked": false},
    ];
  ...
  Future<void> _updateAchievementsProgress(String uid) async {
    ...
    achievements.refresh(); // ✅ Ensures UI updates without another Firestore fetch
  }
}
